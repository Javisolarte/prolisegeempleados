                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad addcoursepro">
                                                    <form action="registrar-lugar.php" method="POST"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group res-mg-t-15">
                                                                    ...
                                                                    <input name="numero_guardias" type="number"
                                                                        class="form-control"
                                                                        placeholder="Número de guardas" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>Numero de camaras </label>
                                                                    <input name="numero_camaras" type="number"
                                                                        class="form-control"
                                                                        placeholder="Número de cámaras" required>
                                                                </div>
                                                                <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="devit-card-custom">
                                                            ...
                                                            <a href="#"
                                                                class="btn btn-primary waves-effect waves-light">Guardar</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
