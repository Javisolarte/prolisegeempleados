                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Lugar</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    if (!isset($_GET['nombre'])) {
                        echo "Nombre de lugar no proporcionado.";
                        exit;
                    }

                    $nombre = $_GET['nombre'];

                    // Consulta usando sentencia preparada para evitar inyección
                    $stmt = $conexion->prepare("SELECT * FROM lugares_seguridad WHERE nombre = ?");
                    ...
                    $direccion = htmlspecialchars($lugar['direccion']);
                    $telefono = htmlspecialchars($lugar['telefono']);
                    $imagen = (!empty($lugar['ruta_imagen']) && file_exists($lugar['ruta_imagen'])) ? $lugar['ruta_imagen'] : 'img/profile/2.png';
                    $camaras = htmlspecialchars($lugar['numero_camaras']);
                    $guardias = htmlspecialchars($lugar['numero_guardias']);
                    $fecha_creacion = htmlspecialchars($lugar['created_at']);
                    ?>

                    <!-- HTML con los datos cargados dinámicamente -->
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="profile-info-inner">
                            <div class="profile-img">
                                <img src="<?php echo $imagen; ?>" alt="Imagen del lugar" />
                            </div>
                            <div class="profile-details-hr">
                                <div class="row">
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                        <div class="address-hr">
                                            <p><b>Nombre</b><br /> <?php echo $nombre_lugar; ?></p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                        <div class="address-hr">
                                            <p><b>Cámaras</b><br /> <?php echo $camaras; ?></p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                        <div class="address-hr tb-sm-res-d-n dps-tb-ntn">
                                            <p><b>Guardias</b><br /> <?php echo $guardias; ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
