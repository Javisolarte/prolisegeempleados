    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo" src="img/logo/logosn.png" style="height: 100px;"
                        alt="" /></a> <br><br>
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Agregar lugar" href="agregar-lugar.html"><span
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="index.html"><img class="main-logo" src="img/logo/logo.png" style="height: 30px;"
                                alt="" /></a>
                    </div>
                </div>
            </div>
                                    ...
                                    <form action="/update" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                    ...
                                                    <div class="file-upload-inner ts-forms">
                                                        <div class="input prepend-big-btn">
                                                            ...
                                                            <div class="file-button">
                                                                Buscar
                                                                <input id="foto_perfil_ruta" name="foto_perfil_ruta"
                                                                    type="file"
                                                                    onchange="document.getElementById('file-name').value = this.value;">
                                                            </div>
                                                            <input type="text" id="file-name"
                                                                placeholder="No se ha seleccionado archivo" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="estado_civil" id="estado_civil" class="form-control"
                                                        required>
                                                        <option value="" selected disabled>Seleccionar estado civil
                                                        </option>
                                                ...
                                                <div class="form-group">
                                                    <textarea name="formacion" class="form-control"
                                                        placeholder="Formación"></textarea>
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    <input name="puesto_asignado" type="text" class="form-control"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="tipo_contrato" id="tipo_contrato" class="form-control"
                                                        required>
                                                        <option value="" selected disabled>Seleccionar tipo de contrato
                                                        </option>
                                                ...
                                                <div class="form-group">
                                                    <input name="sueldo" type="number" step="0.01" class="form-control"
                                                        placeholder="Sueldo (USD)">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="hoja_vida_ruta" name="hoja_vida_ruta" type="file"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="payment-adress mg-t-15">
                                                    <button type="submit"
                                                        class="btn btn-primary waves-effect waves-light mg-b-15">Actualizar</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
