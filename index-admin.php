                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <div class="analytics-sparkle-line reso-mg-b-30">
                                <div class="analytics-content">
                                    <h5>Edad Promedio</h5>
                                    <h2><span class="counter"><?php echo round($promedio_edad); ?></span> <span
                                            class="tuition-fees">años</span></h2>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <div class="analytics-sparkle-line reso-mg-b-30">
                                <div class="analytics-content">
                                    ...
                                    <h2><span class="counter"><?php echo $promedio_experiencia; ?></span> <span
                                            class="tuition-fees">años</span></h2>
                                ...
                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="d-flex justify-content-center my-4">
                                                            <div
                                                                style="background-color: #2874A6; color: white; padding: 30px; border-radius: 15px; width: 100%; max-width: 600px; box-shadow: 0 6px 20px rgba(0,0,0,0.15); text-align: center;">
                                                                ...
                                                                <p style="max-width: 500px; margin: 0 auto 20px;">
                                                                    Este panel administrativo te permite supervisar
                                                                    empleados, asignaciones, horarios, lugares de
                                                                    vigilancia, estadísticas, reportes y mucho más.
                                                                </p>
                                                                <div
                                                                    class="d-flex justify-content-center flex-wrap gap-2">
                                                                    <a href="generar-pdf.php"
                                                                        class="btn btn-warning text-white">
                                                                        <i class="fa fa-users"></i> Ver Empleados
                                                                    </a>
                                                                    <a href="generar-pdf-lugares.php"
                                                                        class="btn btn-warning text-white">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                            ...
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                    <a class="btn btn-primary btn-block"
                                                        href="<?php echo $horario_actual ? $horario_actual['ruta_horario'] : '#'; ?>"
                                                        download>
                                                        Descargar Horario Actual
                                                    </a>
                                                </li>
                                                <li class="list-group-item">
                                                    <a class="btn btn-success btn-block" href="generar-pdf.php"
                                                        target="_blank">
                                                        Descargar Lista de Empleados (PDF)
                                                    </a>
                                                </li>
                                                <li class="list-group-item">
                                                    <a class="btn btn-info btn-block" href="generar-pdf-lugares.php"
                                                        target="_blank">
                                        ...
                                        <div class="white-box analytics-info-cs">
                                            ...
                                            <p><strong>Edad Promedio:</strong> <?php echo round($promedio_edad); ?> años
                                            </p>
                                            <p><strong>Experiencia Promedio:</strong>
                                                <?php echo $promedio_experiencia; ?> años</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
